...
async function updateEmployee(req,res) {
   try {
    ...
    if (!employee_email || !employee_first_name || !employee_last_name || !employee_phone || !company_role_id) {
      return res.status(400).json({ message: 'Missing or invalid request fields' });
    }
